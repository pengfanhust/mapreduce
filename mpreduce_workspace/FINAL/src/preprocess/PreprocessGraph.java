...
/**
 * This job generate the adjacent list graph file from the single edge file.
 * input file contains one edge each line: 
 * 1,2 
 * This means user with id "1" is
 * following user with id "2".
 * 
 * output file using the adjacent list format:
 * 1\t 2,3,4,5,6
 * 
 * THis means user with id "1" is following user 2 3 4 5 6
 * 
 * @author pengfan
 * 
 */
public class PreprocessGraph {
	...
	/**
	 * using per map combiner to emit the adjacent list.
	 * @author pengfan
	 *
	 */
